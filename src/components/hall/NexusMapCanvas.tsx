  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${colA(0.35)}`,
        borderRadius: 14,
        boxShadow: `0 0 24px ${colA(0.18)}`,
        padding: 16,
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
        ...
        <span style={{
          ...
          color: 'rgba(232,240,255,0.85)', fontSize: 13, letterSpacing: 1,
        }}>
          {info.uid}
        </span>
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer',
            color: 'rgba(255,255,255,0.35)', fontSize: 14, lineHeight: 1, padding: 0 }}
        >✕</button>
      </div>

      {/* Trait profile label */}
      <div style={{ color: 'rgba(160,184,216,0.4)', fontSize: 9, letterSpacing: 2.5, marginBottom: 8 }}>
        TRAIT PROFILE
      </div>
        ...
        return (
          <div key={label} style={{ marginBottom: 7 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
              <span style={{ color: 'rgba(160,184,216,0.65)', fontSize: 10, letterSpacing: 0.8 }}>
                {label}
              </span>
              <span style={{ color: colA(0.9), fontSize: 10 }}>
                {Math.round(val * 100)}
              </span>
            </div>
            <div style={{
